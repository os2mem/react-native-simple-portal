...
import { Portal, Host } from 'react-native-simple-portal';

const HostLocation = () => {
  return <View style={[styles.box, styles.hostLocationContainer]}>
...
const PortalLocation = () => {
  ...
  return <View style={[styles.box, styles.portalContainer]}>
    ...
    <Portal hostId="host-location">
      ...
      <Button onPress={() => setCounter(prev => prev + 1)} title="Press Counter" />
...
export default function App() {
  ...
  return (
    <View style={[styles.appContainer]}>
      ...
      <Button title={`${active ? 'Unmount' : 'Mount'} Portal`} onPress={togglePortal} />
    </View>
  );
}
